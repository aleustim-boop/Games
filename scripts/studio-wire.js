...
for(const id of process.argv.slice(2)){
 ...
 if(!s.includes('js/casual-studio.js'))s=s.replace('<script src="js/casual-ui.js','<script src="js/casual-studio.js?v=1"></script><script src="js/casual-ui.js');
 s=s.replaceAll('premium-1','studio-1');fs.writeFileSync(file,s);
}
