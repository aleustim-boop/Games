...
function поднять(исходник, настройки) {
  ...
  /* Общий реестр игр кладём раньше проверяемого скрипта — как страница:
     js/рейтинг-экран.js читает window.ИгрыРеестр при загрузке
     (штаб/план-рейтинг-во-всех-играх.md, Э1). */
  vm.runInContext(fs.readFileSync(path.join(__dirname, '..', 'js', 'игры-реестр.js'), 'utf8'), песочница, { filename: 'js/игры-реестр.js' });
