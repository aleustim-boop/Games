...
(async()=>{
  for(const file of ['катан.html','style-катан.css','js/катан-правила.js','js/катан-бот.js','js/катан-поле.js','js/катан-память.js','js/катан-экран.js','img/катан/обложка.jpg','img/катан/земли.jpg','img/катан/развитие.jpg','img/катан/ресурсы.jpg']){
  ...
  console.log('Опубликованные код, стили и четыре изображения совпадают с проверенными файлами.');
  try{
