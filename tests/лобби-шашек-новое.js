...
(async () => {
  ...
  if (ПОРТ_СЕРВЕРА) {
    ...
    // «лобби-друзья» с 24.09 зовёт window.Сеть.пригласитьВПриложение, а не
    // игру с другом по коду — честного видимого входа к СОЗДАНИЮ приватной
    // комнаты в лобби больше нет, жмём скрытую кнопку напрямую программным
    // кликом (тем же приёмом, что tests/создание-игры-в-шашках.js).
