...
const GAMES=['маджонг','свободная-ячейка','паук','косынка','сапёр','нарды','шахматы','дурак','шашки','домино','морской-бой','катан','монополия','деберц','2048','судоку','японский-кроссворд'];
const DAY=86400000;
